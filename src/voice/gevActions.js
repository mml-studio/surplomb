...
const LAYER_ALIASES = new Map([
  ...
  ["sitadel", 'sitadel-fr'],
  ["building permits", 'sitadel-fr'],
  ["building permit", 'sitadel-fr'],
  ["permits", 'sitadel-fr'],
  ["planning permission", 'sitadel-fr'],
  ["planning permissions", 'sitadel-fr'],
  ["demolition permits", 'sitadel-fr'],
  ["construction permits", 'sitadel-fr'],
  ["permis", 'sitadel-fr'],
  ["permis de construire", 'sitadel-fr'],
  ["permis de demolir", 'sitadel-fr'],
  ["permis de démolir", 'sitadel-fr'],
  ["autorisations d'urbanisme", 'sitadel-fr'],
  ["autorisations d urbanisme", 'sitadel-fr'],
  ["autorisation d'urbanisme", 'sitadel-fr'],
  ["urbanisme sitadel", 'sitadel-fr'],
  ["chantiers", 'sitadel-fr'],
  ["chantier", 'sitadel-fr'],
  ["constructions neuves", 'sitadel-fr'],
  ["logements autorises", 'sitadel-fr'],
  ["logements autorisés", 'sitadel-fr'],
  ["nouveaux logements", 'sitadel-fr'],
  ...
  ["plan d exposition au bruit", 'bruit-fr'],
  ["plan de gene sonore", 'bruit-fr'],
  ["plan de gêne sonore", 'bruit-fr'],
  ["nuisance sonore", 'bruit-fr'],
  ["nuisances sonores", 'bruit-fr'],
  ["décibels", 'bruit-fr'],
  ["insonorisation", 'bruit-fr'],
