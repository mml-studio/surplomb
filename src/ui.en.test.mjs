...
test('every string src/ui.js can draw has an English with no French left in it', (t) => {
  ...
  assertNoFrench([
    ...
    m.cctv.plainMeta(m.cctv.osmProvider, m.cctv.directionUnknown),
    m.cctv.timelapseReady(60, 58),
    m.cctv.timelapseReady(12, 12),
    m.cctv.timelapseBuilding(3, '11:23 AM'),
    m.cctv.timelapseBuilding(0, '--:--'),
    m.cctv.timelapseLoading(12, 60),
