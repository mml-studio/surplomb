...
Fifty-nine layers. **Fifty-six of them need nothing at all** — no key, no account, no signup. Exactly three want a free key: Ships and ports, Generating units and Active fires (FIRMS). Every layer added since is keyless, including the newest — traffic counts, recorded crime, mobile antennas, cool islands, planning permits, airport noise, everyday amenities, and the Gironde megafire of July 2026 replayed along a cursor. (🟢 nothing · 🟡 free key · 🔴 metered.)
